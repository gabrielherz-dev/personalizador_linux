 # !/bin/bash
 # Clase para la instalación del gestor de ventanas KDE para X11
 #
 ...
 KDEXSApp.new(){
  ...
  local tema=$2
	...
	unset self
 	...
 	rself["plasma-desktop"]="plasma-open-settings --version"
  rself["systemsettings"]="systemsettings --version"
  rself["kwin-x11"]="systemsettings --version"

}

# Métodos heredados
KDEXSApp.installApps(){
