...
config.font = wezterm.font_with_fallback({
	...
	{ family = "DejaVu Sans Mono", scale = 1.3 },
})
...
-- Keys
config.leader = { key = "a", mods = "CTRL", timeout_milliseconds = 1002 }
config.keys = {
	...
	--  Para cerrar el pane abierto horizontalmente
	{ key = "x", mods = "LEADER|SHIFT", action = act.CloseCurrentPane({ confirm = true }) },
	--  Para cerrar el pane abierto horizontalmente
	{ key = "z", mods = "LEADER|SHIFT", action = act.CloseCurrentPane({ confirm = true }) },
	-- Para mover entre los panes
	...
	--stat_color	{ key = "z", mods = "LEADER", action = act.TogglePaneZoomState },
